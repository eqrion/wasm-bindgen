...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpTransceiver" , js_name = mid ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpTransceiver" , js_name = sender ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpTransceiver" , js_name = receiver ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpTransceiver" , js_name = stopped ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpTransceiver" , js_name = direction ) ]
    ...
    #[cfg(feature = "RtcRtpTransceiverDirection")]
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCRtpTransceiver" , js_name = direction ) ]
    ...
    #[cfg(feature = "RtcRtpTransceiverDirection")]
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpTransceiver" , js_name = currentDirection ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpTransceiver" , js_name = getRemoteTrackId ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpTransceiver" , js_name = stop ) ]
    #[doc = "The `stop()` method."]
    #[doc = ""]
