...
extern "C" {
    ...
    pub type TimeRanges;
    # [ wasm_bindgen ( final , method , getter , js_class = "TimeRanges" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TimeRanges" , js_name = end ) ]
    #[doc = "The `end()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TimeRanges" , js_name = start ) ]
