...
extern "C" {
    ...
    pub type TreeWalker;
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "TreeWalker" , js_name = root ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TreeWalker" , js_name = whatToShow ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TreeWalker" , js_name = filter ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "TreeWalker" , js_name = currentNode ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , setter , js_class = "TreeWalker" , js_name = currentNode ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = firstChild ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = lastChild ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = nextNode ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = nextSibling ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = parentNode ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = previousNode ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeWalker" , js_name = previousSibling ) ]
