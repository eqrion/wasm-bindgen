...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TransitionEvent" , js_name = propertyName ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TransitionEvent" , js_name = elapsedTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TransitionEvent" , js_name = pseudoElement ) ]
