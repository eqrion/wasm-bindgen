...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AbortSignal" , js_name = aborted ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AbortSignal" , js_name = onabort ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "AbortSignal" , js_name = onabort ) ]
