...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLMenuElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLMenuElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLMenuElement" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLMenuElement" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLMenuElement" , js_name = compact ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLMenuElement" , js_name = compact ) ]
