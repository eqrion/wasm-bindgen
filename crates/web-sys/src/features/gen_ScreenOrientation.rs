...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "ScreenOrientation" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "ScreenOrientation" , js_name = angle ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ScreenOrientation" , js_name = onchange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ScreenOrientation" , js_name = onchange ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ScreenOrientation" , js_name = lock ) ]
    #[doc = "The `lock()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ScreenOrientation" , js_name = unlock ) ]
