...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMStringList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "DOMStringList" , js_name = contains ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "DOMStringList" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
