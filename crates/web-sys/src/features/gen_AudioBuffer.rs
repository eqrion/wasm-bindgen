...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioBuffer" , js_name = sampleRate ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioBuffer" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioBuffer" , js_name = duration ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioBuffer" , js_name = numberOfChannels ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioBuffer" , js_name = copyFromChannel ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioBuffer" , js_name = copyToChannel ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioBuffer" , js_name = getChannelData ) ]
