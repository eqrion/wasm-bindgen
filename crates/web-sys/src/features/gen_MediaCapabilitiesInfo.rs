...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaCapabilitiesInfo" , js_name = supported ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaCapabilitiesInfo" , js_name = smooth ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaCapabilitiesInfo" , js_name = powerEfficient ) ]
