...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WebGLShaderPrecisionFormat" , js_name = rangeMin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WebGLShaderPrecisionFormat" , js_name = rangeMax ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WebGLShaderPrecisionFormat" , js_name = precision ) ]
