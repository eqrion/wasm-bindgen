...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CompositionEvent" , js_name = data ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CompositionEvent" , js_name = locale ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CompositionEvent" , js_name = initCompositionEvent ) ]
