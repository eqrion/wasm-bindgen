...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "AudioWorkletNode" , js_name = parameters ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "AudioWorkletNode" , js_name = port ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioWorkletNode" , js_name = onprocessorerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioWorkletNode" , js_name = onprocessorerror ) ]
