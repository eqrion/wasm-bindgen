...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Presentation" , js_name = defaultRequest ) ]
    ...
    #[cfg(feature = "PresentationRequest")]
    # [ wasm_bindgen ( final , method , setter , js_class = "Presentation" , js_name = defaultRequest ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Presentation" , js_name = receiver ) ]
