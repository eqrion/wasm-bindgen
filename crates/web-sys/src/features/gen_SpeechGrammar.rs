...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "SpeechGrammar" , js_name = src ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , setter , js_class = "SpeechGrammar" , js_name = src ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "SpeechGrammar" , js_name = weight ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , setter , js_class = "SpeechGrammar" , js_name = weight ) ]
