...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadHapticActuator" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "GamepadHapticActuator" , js_name = pulse ) ]
