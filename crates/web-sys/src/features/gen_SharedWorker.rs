...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SharedWorker" , js_name = port ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SharedWorker" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SharedWorker" , js_name = onerror ) ]
