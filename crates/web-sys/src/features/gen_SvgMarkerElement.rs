...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = refX ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = refY ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = markerUnits ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = markerWidth ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = markerHeight ) ]
    ...
    #[cfg(feature = "SvgAnimatedEnumeration")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = orientType ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = orientAngle ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = viewBox ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMarkerElement" , js_name = preserveAspectRatio ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGMarkerElement" , js_name = setOrientToAngle ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGMarkerElement" , js_name = setOrientToAuto ) ]
