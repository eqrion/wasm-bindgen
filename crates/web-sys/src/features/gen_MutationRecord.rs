...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = type ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = target ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = addedNodes ) ]
    ...
    #[cfg(feature = "NodeList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = removedNodes ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = previousSibling ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = nextSibling ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = attributeName ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = attributeNamespace ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MutationRecord" , js_name = oldValue ) ]
