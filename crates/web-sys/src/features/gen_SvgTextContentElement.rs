...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTextContentElement" , js_name = textLength ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTextContentElement" , js_name = lengthAdjust ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGTextContentElement" , js_name = getCharNumAtPosition ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGTextContentElement" , js_name = getComputedTextLength ) ]
    ...
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTextContentElement" , js_name = getEndPositionOfChar ) ]
    ...
    #[cfg(feature = "SvgRect")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTextContentElement" , js_name = getExtentOfChar ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGTextContentElement" , js_name = getNumberOfChars ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTextContentElement" , js_name = getRotationOfChar ) ]
    ...
    pub fn get_rotation_of_char(this: &SvgTextContentElement, charnum: u32)
        -> Result<f32, JsValue>;
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTextContentElement" , js_name = getStartPositionOfChar ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTextContentElement" , js_name = getSubStringLength ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTextContentElement" , js_name = selectSubString ) ]
