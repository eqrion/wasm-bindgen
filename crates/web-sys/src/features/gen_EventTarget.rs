...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "EventTarget" , js_name = addEventListener ) ]
    ...
    #[cfg(feature = "Event")]
    # [ wasm_bindgen ( catch , method , final , js_class = "EventTarget" , js_name = dispatchEvent ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "EventTarget" , js_name = removeEventListener ) ]
