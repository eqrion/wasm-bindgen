...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLAllCollection" , js_name = length ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( method , final , js_class = "HTMLAllCollection" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "HTMLAllCollection" , js_name = namedItem ) ]
