...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "OffscreenCanvas" , js_name = width ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "OffscreenCanvas" , js_name = width ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "OffscreenCanvas" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "OffscreenCanvas" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "OffscreenCanvas" , js_name = getContext ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "OffscreenCanvas" , js_name = toBlob ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "OffscreenCanvas" , js_name = transferToImageBitmap ) ]
