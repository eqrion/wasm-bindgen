...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadButton" , js_name = pressed ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadButton" , js_name = touched ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadButton" , js_name = value ) ]
