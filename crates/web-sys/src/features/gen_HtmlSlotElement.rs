...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLSlotElement" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLSlotElement" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "HTMLSlotElement" , js_name = assignedNodes ) ]
