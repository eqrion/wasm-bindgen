...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRFrameData" , js_name = timestamp ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRFrameData" , js_name = leftProjectionMatrix ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRFrameData" , js_name = leftViewMatrix ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRFrameData" , js_name = rightProjectionMatrix ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRFrameData" , js_name = rightViewMatrix ) ]
    ...
    #[cfg(feature = "VrPose")]
    # [ wasm_bindgen ( final , method , getter , js_class = "VRFrameData" , js_name = pose ) ]
