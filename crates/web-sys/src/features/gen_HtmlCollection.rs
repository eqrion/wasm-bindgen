...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLCollection" , js_name = length ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "HTMLCollection" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "HTMLCollection" , js_name = namedItem ) ]
