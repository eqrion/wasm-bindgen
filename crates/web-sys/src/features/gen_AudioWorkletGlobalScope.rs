...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioWorkletGlobalScope" , js_name = currentFrame ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioWorkletGlobalScope" , js_name = currentTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioWorkletGlobalScope" , js_name = sampleRate ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "AudioWorkletGlobalScope" , js_name = registerProcessor ) ]
