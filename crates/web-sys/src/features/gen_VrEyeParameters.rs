...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VREyeParameters" , js_name = offset ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VREyeParameters" , js_name = fieldOfView ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VREyeParameters" , js_name = renderWidth ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VREyeParameters" , js_name = renderHeight ) ]
