...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedNumberList" , js_name = baseVal ) ]
    ...
    #[cfg(feature = "SvgNumberList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedNumberList" , js_name = animVal ) ]
