...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "Geolocation" , js_name = clearWatch ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Geolocation" , js_name = getCurrentPosition ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Geolocation" , js_name = watchPosition ) ]
