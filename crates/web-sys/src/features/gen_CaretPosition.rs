...
extern "C" {
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "CaretPosition" , js_name = offsetNode ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CaretPosition" , js_name = offset ) ]
    ...
    #[cfg(feature = "DomRect")]
    # [ wasm_bindgen ( method , final , js_class = "CaretPosition" , js_name = getClientRect ) ]
