...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpReceiver" , js_name = track ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpReceiver" , js_name = getContributingSources ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpReceiver" , js_name = getStats ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpReceiver" , js_name = getSynchronizationSources ) ]
