...
extern "C" {
    ...
    pub type MimeType;
    # [ wasm_bindgen ( final , method , getter , js_class = "MimeType" , js_name = description ) ]
    ...
    #[cfg(feature = "Plugin")]
    # [ wasm_bindgen ( final , method , getter , js_class = "MimeType" , js_name = enabledPlugin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MimeType" , js_name = suffixes ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MimeType" , js_name = type ) ]
