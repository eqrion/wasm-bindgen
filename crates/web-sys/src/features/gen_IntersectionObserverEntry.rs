...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = time ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = rootBounds ) ]
    ...
    #[cfg(feature = "DomRectReadOnly")]
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = boundingClientRect ) ]
    ...
    #[cfg(feature = "DomRectReadOnly")]
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = intersectionRect ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = isIntersecting ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = intersectionRatio ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserverEntry" , js_name = target ) ]
