...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSImportRule" , js_name = href ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSImportRule" , js_name = media ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSImportRule" , js_name = styleSheet ) ]
