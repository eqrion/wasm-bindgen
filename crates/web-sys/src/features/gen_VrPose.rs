...
extern "C" {
    ...
    pub type VrPose;
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRPose" , js_name = position ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRPose" , js_name = linearVelocity ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRPose" , js_name = linearAcceleration ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRPose" , js_name = orientation ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRPose" , js_name = angularVelocity ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRPose" , js_name = angularAcceleration ) ]
