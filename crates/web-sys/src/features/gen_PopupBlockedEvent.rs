...
extern "C" {
    ...
    #[cfg(feature = "Window")]
    # [ wasm_bindgen ( final , method , getter , js_class = "PopupBlockedEvent" , js_name = requestingWindow ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PopupBlockedEvent" , js_name = popupWindowName ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PopupBlockedEvent" , js_name = popupWindowFeatures ) ]
