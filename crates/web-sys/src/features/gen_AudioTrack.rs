...
extern "C" {
    ...
    pub type AudioTrack;
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioTrack" , js_name = id ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioTrack" , js_name = kind ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioTrack" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioTrack" , js_name = language ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioTrack" , js_name = enabled ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioTrack" , js_name = enabled ) ]
