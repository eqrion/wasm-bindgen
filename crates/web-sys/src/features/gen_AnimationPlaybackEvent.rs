...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AnimationPlaybackEvent" , js_name = currentTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AnimationPlaybackEvent" , js_name = timelineTime ) ]
