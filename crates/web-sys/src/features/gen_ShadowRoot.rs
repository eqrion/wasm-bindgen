...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = mode ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = host ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = innerHTML ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ShadowRoot" , js_name = innerHTML ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = activeElement ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = styleSheets ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = pointerLockElement ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "ShadowRoot" , js_name = fullscreenElement ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "ShadowRoot" , js_name = getElementById ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ShadowRoot" , js_name = getElementsByClassName ) ]
    ...
    #[cfg(feature = "HtmlCollection")]
    # [ wasm_bindgen ( method , final , js_class = "ShadowRoot" , js_name = getElementsByTagName ) ]
    ...
    #[cfg(feature = "HtmlCollection")]
    # [ wasm_bindgen ( method , final , js_class = "ShadowRoot" , js_name = getElementsByTagNameNS ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "ShadowRoot" , js_name = elementFromPoint ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ShadowRoot" , js_name = elementsFromPoint ) ]
