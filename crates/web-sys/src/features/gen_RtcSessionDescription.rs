...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCSessionDescription" , js_name = type ) ]
    ...
    #[cfg(feature = "RtcSdpType")]
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCSessionDescription" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCSessionDescription" , js_name = sdp ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCSessionDescription" , js_name = sdp ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCSessionDescription" , js_name = toJSON ) ]
