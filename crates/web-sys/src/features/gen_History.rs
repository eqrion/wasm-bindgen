...
extern "C" {
    ...
    pub type History;
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "History" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "History" , js_name = scrollRestoration ) ]
    ...
    #[cfg(feature = "ScrollRestoration")]
    # [ wasm_bindgen ( final , catch , method , setter , js_class = "History" , js_name = scrollRestoration ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "History" , js_name = state ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "History" , js_name = back ) ]
    #[doc = "The `back()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "History" , js_name = forward ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "History" , js_name = go ) ]
    #[doc = "The `go()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "History" , js_name = pushState ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "History" , js_name = replaceState ) ]
