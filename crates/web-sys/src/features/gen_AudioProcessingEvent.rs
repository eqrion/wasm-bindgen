...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioProcessingEvent" , js_name = playbackTime ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "AudioProcessingEvent" , js_name = inputBuffer ) ]
    ...
    #[cfg(feature = "AudioBuffer")]
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "AudioProcessingEvent" , js_name = outputBuffer ) ]
