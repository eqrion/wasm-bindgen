...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySystemAccess" , js_name = keySystem ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySystemAccess" , js_name = createMediaKeys ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySystemAccess" , js_name = getConfiguration ) ]
