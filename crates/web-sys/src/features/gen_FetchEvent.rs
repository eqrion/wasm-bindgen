...
extern "C" {
    ...
    pub type FetchEvent;
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchEvent" , js_name = request ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchEvent" , js_name = clientId ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchEvent" , js_name = isReload ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "FetchEvent" , js_name = respondWith ) ]
