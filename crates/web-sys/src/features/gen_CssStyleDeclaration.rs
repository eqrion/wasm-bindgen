...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSStyleDeclaration" , js_name = cssText ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "CSSStyleDeclaration" , js_name = cssText ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSStyleDeclaration" , js_name = length ) ]
    ...
    #[cfg(feature = "CssRule")]
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSStyleDeclaration" , js_name = parentRule ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CSSStyleDeclaration" , js_name = getPropertyPriority ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSStyleDeclaration" , js_name = getPropertyValue ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CSSStyleDeclaration" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSStyleDeclaration" , js_name = removeProperty ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSStyleDeclaration" , js_name = setProperty ) ]
