...
extern "C" {
    ...
    pub type IdbFactory;
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBFactory" , js_name = cmp ) ]
    #[doc = "The `cmp()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBFactory" , js_name = deleteDatabase ) ]
    ...
    #[cfg(feature = "IdbOpenDbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBFactory" , js_name = open ) ]
    #[doc = "The `open()` method."]
    #[doc = ""]
