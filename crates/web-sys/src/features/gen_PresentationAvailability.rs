...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PresentationAvailability" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PresentationAvailability" , js_name = onchange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "PresentationAvailability" , js_name = onchange ) ]
