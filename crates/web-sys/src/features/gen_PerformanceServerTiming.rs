...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceServerTiming" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceServerTiming" , js_name = duration ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceServerTiming" , js_name = description ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "PerformanceServerTiming" , js_name = toJSON ) ]
