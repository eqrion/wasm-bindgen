...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLOptGroupElement" , js_name = disabled ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLOptGroupElement" , js_name = disabled ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLOptGroupElement" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLOptGroupElement" , js_name = label ) ]
