...
extern "C" {
    ...
    pub type Xr;
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "XR" , js_name = ondevicechange ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , setter , js_class = "XR" , js_name = ondevicechange ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "XR" , js_name = isSessionSupported ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "XrSessionMode")]
    # [ wasm_bindgen ( method , final , js_class = "XR" , js_name = requestSession ) ]
