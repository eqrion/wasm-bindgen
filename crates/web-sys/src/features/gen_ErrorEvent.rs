...
extern "C" {
    ...
    pub type ErrorEvent;
    # [ wasm_bindgen ( final , method , getter , js_class = "ErrorEvent" , js_name = message ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ErrorEvent" , js_name = filename ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ErrorEvent" , js_name = lineno ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ErrorEvent" , js_name = colno ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ErrorEvent" , js_name = error ) ]
