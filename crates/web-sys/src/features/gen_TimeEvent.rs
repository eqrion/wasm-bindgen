...
extern "C" {
    ...
    pub type TimeEvent;
    # [ wasm_bindgen ( final , method , getter , js_class = "TimeEvent" , js_name = detail ) ]
    ...
    #[cfg(feature = "Window")]
    # [ wasm_bindgen ( final , method , getter , js_class = "TimeEvent" , js_name = view ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TimeEvent" , js_name = initTimeEvent ) ]
