...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMImplementation" , js_name = createDocument ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMImplementation" , js_name = createDocumentType ) ]
    ...
    #[cfg(feature = "Document")]
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMImplementation" , js_name = createHTMLDocument ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "DOMImplementation" , js_name = hasFeature ) ]
