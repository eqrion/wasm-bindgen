...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGLineElement" , js_name = x1 ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGLineElement" , js_name = y1 ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGLineElement" , js_name = x2 ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGLineElement" , js_name = y2 ) ]
