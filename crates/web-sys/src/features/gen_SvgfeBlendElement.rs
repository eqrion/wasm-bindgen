...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = in1 ) ]
    ...
    #[cfg(feature = "SvgAnimatedString")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = in2 ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = mode ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = height ) ]
    ...
    #[cfg(feature = "SvgAnimatedString")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEBlendElement" , js_name = result ) ]
