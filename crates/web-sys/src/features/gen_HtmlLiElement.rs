...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLIElement" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLLIElement" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLIElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLLIElement" , js_name = type ) ]
