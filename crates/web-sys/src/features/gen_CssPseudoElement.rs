...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSPseudoElement" , js_name = type ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSPseudoElement" , js_name = parentElement ) ]
