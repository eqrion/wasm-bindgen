...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "StorageManager" , js_name = estimate ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "StorageManager" , js_name = persist ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "StorageManager" , js_name = persisted ) ]
