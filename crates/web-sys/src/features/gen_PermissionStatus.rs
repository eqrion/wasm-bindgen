...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PermissionStatus" , js_name = state ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PermissionStatus" , js_name = onchange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "PermissionStatus" , js_name = onchange ) ]
