...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGStringList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGStringList" , js_name = numberOfItems ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGStringList" , js_name = appendItem ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGStringList" , js_name = clear ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGStringList" , js_name = getItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGStringList" , js_name = initialize ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGStringList" , js_name = insertItemBefore ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGStringList" , js_name = removeItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGStringList" , js_name = replaceItem ) ]
