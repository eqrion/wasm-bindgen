...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "CheckerboardReportService" , js_name = flushActiveReports ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CheckerboardReportService" , js_name = getReports ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CheckerboardReportService" , js_name = isRecordingEnabled ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CheckerboardReportService" , js_name = setRecordingEnabled ) ]
