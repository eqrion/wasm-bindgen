...
extern "C" {
    ...
    pub type IdbIndex;
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBIndex" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "IDBIndex" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBIndex" , js_name = objectStore ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "IDBIndex" , js_name = keyPath ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBIndex" , js_name = multiEntry ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBIndex" , js_name = unique ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBIndex" , js_name = locale ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBIndex" , js_name = isAutoLocale ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = count ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = getAll ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = getAllKeys ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = getKey ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = openCursor ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBIndex" , js_name = openKeyCursor ) ]
