...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PushManager" , js_name = getSubscription ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PushManager" , js_name = permissionState ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PushManager" , js_name = subscribe ) ]
