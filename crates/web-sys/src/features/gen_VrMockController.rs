...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockController" , js_name = newAxisMoveEvent ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockController" , js_name = newButtonEvent ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockController" , js_name = newPoseMove ) ]
