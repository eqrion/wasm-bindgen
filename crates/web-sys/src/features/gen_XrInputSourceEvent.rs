...
extern "C" {
    ...
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "XrFrame")]
    # [ wasm_bindgen ( final , method , getter , js_class = "XRInputSourceEvent" , js_name = frame ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "XRInputSourceEvent" , js_name = inputSource ) ]
