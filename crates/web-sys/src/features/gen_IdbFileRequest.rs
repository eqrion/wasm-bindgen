...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBFileRequest" , js_name = fileHandle ) ]
    ...
    #[cfg(feature = "IdbFileHandle")]
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBFileRequest" , js_name = lockedFile ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBFileRequest" , js_name = onprogress ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "IDBFileRequest" , js_name = onprogress ) ]
