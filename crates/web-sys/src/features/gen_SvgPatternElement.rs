...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = patternUnits ) ]
    ...
    #[cfg(feature = "SvgAnimatedEnumeration")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = patternContentUnits ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = patternTransform ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = viewBox ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = preserveAspectRatio ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPatternElement" , js_name = href ) ]
