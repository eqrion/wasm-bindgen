...
extern "C" {
    ...
    pub type Cache;
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = add ) ]
    #[doc = "The `add()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = addAll ) ]
    ...
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = delete ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = keys ) ]
    #[doc = "The `keys()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = match ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = matchAll ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Cache" , js_name = put ) ]
    #[doc = "The `put()` method."]
    #[doc = ""]
