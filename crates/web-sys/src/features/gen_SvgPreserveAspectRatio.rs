...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPreserveAspectRatio" , js_name = align ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPreserveAspectRatio" , js_name = align ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPreserveAspectRatio" , js_name = meetOrSlice ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPreserveAspectRatio" , js_name = meetOrSlice ) ]
