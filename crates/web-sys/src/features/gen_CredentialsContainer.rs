...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CredentialsContainer" , js_name = create ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CredentialsContainer" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CredentialsContainer" , js_name = preventSilentAccess ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CredentialsContainer" , js_name = store ) ]
