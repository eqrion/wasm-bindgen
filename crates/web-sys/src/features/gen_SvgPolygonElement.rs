...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPolygonElement" , js_name = points ) ]
    ...
    #[cfg(feature = "SvgPointList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPolygonElement" , js_name = animatedPoints ) ]
