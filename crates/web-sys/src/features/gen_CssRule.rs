...
extern "C" {
    ...
    pub type CssRule;
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSRule" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSRule" , js_name = cssText ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "CSSRule" , js_name = cssText ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSRule" , js_name = parentRule ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSRule" , js_name = parentStyleSheet ) ]
