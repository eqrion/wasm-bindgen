...
extern "C" {
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "FormData" , js_name = append ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "FormData" , js_name = delete ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "FormData" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "FormData" , js_name = getAll ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "FormData" , js_name = has ) ]
    #[doc = "The `has()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "FormData" , js_name = set ) ]
    #[doc = "The `set()` method."]
    #[doc = ""]
