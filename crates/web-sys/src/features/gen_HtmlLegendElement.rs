...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLegendElement" , js_name = form ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLegendElement" , js_name = align ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLLegendElement" , js_name = align ) ]
