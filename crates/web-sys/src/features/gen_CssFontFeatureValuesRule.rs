...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSFontFeatureValuesRule" , js_name = fontFamily ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "CSSFontFeatureValuesRule" , js_name = fontFamily ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSFontFeatureValuesRule" , js_name = valueText ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "CSSFontFeatureValuesRule" , js_name = valueText ) ]
