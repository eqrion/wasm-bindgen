...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaStreamError" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaStreamError" , js_name = message ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaStreamError" , js_name = constraint ) ]
