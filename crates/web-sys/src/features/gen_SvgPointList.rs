...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPointList" , js_name = numberOfItems ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = appendItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = clear ) ]
    ...
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = getItem ) ]
    ...
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = initialize ) ]
    ...
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = insertItemBefore ) ]
    ...
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = removeItem ) ]
    ...
    #[cfg(feature = "SvgPoint")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGPointList" , js_name = replaceItem ) ]
