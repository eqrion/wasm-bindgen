...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ProgressEvent" , js_name = lengthComputable ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ProgressEvent" , js_name = loaded ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ProgressEvent" , js_name = total ) ]
