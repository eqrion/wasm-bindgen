...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = ensureIndexIsVisible ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = getIndexOfFirstVisibleRow ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = getIndexOfItem ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = getItemAtIndex ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = getNumberOfVisibleRows ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = getRowCount ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = getRowHeight ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = scrollByLines ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ListBoxObject" , js_name = scrollToIndex ) ]
