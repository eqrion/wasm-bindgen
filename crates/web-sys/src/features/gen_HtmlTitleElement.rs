...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "HTMLTitleElement" , js_name = text ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , setter , js_class = "HTMLTitleElement" , js_name = text ) ]
