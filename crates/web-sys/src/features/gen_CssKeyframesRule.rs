...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSKeyframesRule" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "CSSKeyframesRule" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSKeyframesRule" , js_name = cssRules ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CSSKeyframesRule" , js_name = appendRule ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CSSKeyframesRule" , js_name = deleteRule ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CSSKeyframesRule" , js_name = findRule ) ]
