...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPathSegMovetoAbs" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPathSegMovetoAbs" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPathSegMovetoAbs" , js_name = y ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPathSegMovetoAbs" , js_name = y ) ]
