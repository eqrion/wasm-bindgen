...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGSymbolElement" , js_name = viewBox ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGSymbolElement" , js_name = preserveAspectRatio ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGSymbolElement" , js_name = requiredFeatures ) ]
    ...
    #[cfg(feature = "SvgStringList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGSymbolElement" , js_name = requiredExtensions ) ]
    ...
    #[cfg(feature = "SvgStringList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGSymbolElement" , js_name = systemLanguage ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGSymbolElement" , js_name = hasExtension ) ]
