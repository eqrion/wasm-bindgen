...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGImageElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGImageElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGImageElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGImageElement" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGImageElement" , js_name = preserveAspectRatio ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGImageElement" , js_name = href ) ]
