...
extern "C" {
    ...
    pub type TreeView;
    # [ wasm_bindgen ( final , method , getter , js_class = "TreeView" , js_name = rowCount ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = canDrop ) ]
    ...
    #[cfg(feature = "DataTransfer")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = drop ) ]
    #[doc = "The `drop()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = getLevel ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = getParentIndex ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = getRowProperties ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = hasNextSibling ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = isContainer ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = isContainerEmpty ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = isContainerOpen ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = isSeparator ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TreeView" , js_name = isSorted ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TreeView" , js_name = performAction ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TreeView" , js_name = performActionOnRow ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TreeView" , js_name = selectionChanged ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = setTree ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TreeView" , js_name = toggleOpenState ) ]
