...
extern "C" {
    ...
    pub type UiEvent;
    #[cfg(feature = "Window")]
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = view ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = detail ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = layerX ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = layerY ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = pageX ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = pageY ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = which ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = rangeParent ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "UIEvent" , js_name = rangeOffset ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "UIEvent" , js_name = initUIEvent ) ]
