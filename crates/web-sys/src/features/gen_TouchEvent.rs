...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = touches ) ]
    ...
    #[cfg(feature = "TouchList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = targetTouches ) ]
    ...
    #[cfg(feature = "TouchList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = changedTouches ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = altKey ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = metaKey ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = ctrlKey ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TouchEvent" , js_name = shiftKey ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TouchEvent" , js_name = initTouchEvent ) ]
