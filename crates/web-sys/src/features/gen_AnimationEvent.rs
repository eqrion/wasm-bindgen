...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AnimationEvent" , js_name = animationName ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AnimationEvent" , js_name = elapsedTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AnimationEvent" , js_name = pseudoElement ) ]
