...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedLengthList" , js_name = baseVal ) ]
    ...
    #[cfg(feature = "SvgLengthList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedLengthList" , js_name = animVal ) ]
