...
extern "C" {
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "GPUQuerySet" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , setter , js_class = "GPUQuerySet" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUQuerySet" , js_name = destroy ) ]
