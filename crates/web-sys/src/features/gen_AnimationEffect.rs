...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "AnimationEffect" , js_name = getComputedTiming ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "AnimationEffect" , js_name = getTiming ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "AnimationEffect" , js_name = updateTiming ) ]
