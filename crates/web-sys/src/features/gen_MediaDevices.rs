...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaDevices" , js_name = ondevicechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MediaDevices" , js_name = ondevicechange ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaDevices" , js_name = enumerateDevices ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaDevices" , js_name = getSupportedConstraints ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaDevices" , js_name = getUserMedia ) ]
