...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechGrammarList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SpeechGrammarList" , js_name = addFromString ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SpeechGrammarList" , js_name = addFromURI ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SpeechGrammarList" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
