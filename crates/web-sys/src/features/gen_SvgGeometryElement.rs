...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGeometryElement" , js_name = pathLength ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGGeometryElement" , js_name = getPointAtLength ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGGeometryElement" , js_name = getTotalLength ) ]
