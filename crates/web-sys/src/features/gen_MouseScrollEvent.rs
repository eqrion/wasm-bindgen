...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MouseScrollEvent" , js_name = axis ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MouseScrollEvent" , js_name = initMouseScrollEvent ) ]
