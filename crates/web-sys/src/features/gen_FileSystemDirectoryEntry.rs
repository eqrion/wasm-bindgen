...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "FileSystemDirectoryEntry" , js_name = createReader ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "FileSystemDirectoryEntry" , js_name = getDirectory ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "FileSystemDirectoryEntry" , js_name = getFile ) ]
