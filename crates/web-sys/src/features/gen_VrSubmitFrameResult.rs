...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRSubmitFrameResult" , js_name = frameNum ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRSubmitFrameResult" , js_name = base64Image ) ]
