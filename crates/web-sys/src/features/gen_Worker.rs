...
extern "C" {
    ...
    pub type Worker;
    # [ wasm_bindgen ( final , method , getter , js_class = "Worker" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "Worker" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Worker" , js_name = onmessageerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "Worker" , js_name = onmessageerror ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Worker" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "Worker" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Worker" , js_name = postMessage ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Worker" , js_name = terminate ) ]
