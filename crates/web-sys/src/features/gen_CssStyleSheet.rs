...
extern "C" {
    ...
    #[cfg(feature = "CssRule")]
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSStyleSheet" , js_name = ownerRule ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "CSSStyleSheet" , js_name = cssRules ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSStyleSheet" , js_name = deleteRule ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSStyleSheet" , js_name = insertRule ) ]
