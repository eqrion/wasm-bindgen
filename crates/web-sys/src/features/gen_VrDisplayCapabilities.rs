...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRDisplayCapabilities" , js_name = hasPosition ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRDisplayCapabilities" , js_name = hasOrientation ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRDisplayCapabilities" , js_name = hasExternalDisplay ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRDisplayCapabilities" , js_name = canPresent ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRDisplayCapabilities" , js_name = maxLayers ) ]
