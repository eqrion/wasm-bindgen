...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "ScrollBoxObject" , js_name = positionX ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "ScrollBoxObject" , js_name = positionY ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "ScrollBoxObject" , js_name = scrolledWidth ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "ScrollBoxObject" , js_name = scrolledHeight ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( catch , method , final , js_class = "ScrollBoxObject" , js_name = ensureElementIsVisible ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ScrollBoxObject" , js_name = scrollBy ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ScrollBoxObject" , js_name = scrollByIndex ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ScrollBoxObject" , js_name = scrollTo ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( catch , method , final , js_class = "ScrollBoxObject" , js_name = scrollToElement ) ]
