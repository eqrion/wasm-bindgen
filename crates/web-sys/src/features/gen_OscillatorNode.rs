...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "OscillatorNode" , js_name = type ) ]
    ...
    #[cfg(feature = "OscillatorType")]
    # [ wasm_bindgen ( final , method , setter , js_class = "OscillatorNode" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "OscillatorNode" , js_name = frequency ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "OscillatorNode" , js_name = detune ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "OscillatorNode" , js_name = onended ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "OscillatorNode" , js_name = onended ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "OscillatorNode" , js_name = setPeriodicWave ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "OscillatorNode" , js_name = start ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "OscillatorNode" , js_name = stop ) ]
    #[doc = "The `stop()` method."]
    #[doc = ""]
