...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLMapElement" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLMapElement" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLMapElement" , js_name = areas ) ]
