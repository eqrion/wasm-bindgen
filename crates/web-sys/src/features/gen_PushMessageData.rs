...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PushMessageData" , js_name = arrayBuffer ) ]
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "PushMessageData" , js_name = blob ) ]
    #[doc = "The `blob()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PushMessageData" , js_name = json ) ]
    #[doc = "The `json()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "PushMessageData" , js_name = text ) ]
    #[doc = "The `text()` method."]
    #[doc = ""]
