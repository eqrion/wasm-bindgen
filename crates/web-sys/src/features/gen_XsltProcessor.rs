...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "XSLTProcessor" , js_name = clearParameters ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "XSLTProcessor" , js_name = importStylesheet ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "XSLTProcessor" , js_name = removeParameter ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "XSLTProcessor" , js_name = reset ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "XSLTProcessor" , js_name = setParameter ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "XSLTProcessor" , js_name = transformToDocument ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "XSLTProcessor" , js_name = transformToFragment ) ]
