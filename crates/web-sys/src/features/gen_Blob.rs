...
extern "C" {
    ...
    pub type Blob;
    # [ wasm_bindgen ( final , method , getter , js_class = "Blob" , js_name = size ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Blob" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Blob" , js_name = arrayBuffer ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Blob" , js_name = slice ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Blob" , js_name = text ) ]
    #[doc = "The `text()` method."]
    #[doc = ""]
