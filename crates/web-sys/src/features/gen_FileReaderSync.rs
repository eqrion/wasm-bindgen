...
extern "C" {
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "FileReaderSync" , js_name = readAsArrayBuffer ) ]
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "FileReaderSync" , js_name = readAsBinaryString ) ]
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "FileReaderSync" , js_name = readAsDataURL ) ]
    ...
    #[cfg(feature = "Blob")]
    # [ wasm_bindgen ( catch , method , final , js_class = "FileReaderSync" , js_name = readAsText ) ]
