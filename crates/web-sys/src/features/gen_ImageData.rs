...
extern "C" {
    ...
    pub type ImageData;
    # [ wasm_bindgen ( final , method , getter , js_class = "ImageData" , js_name = width ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ImageData" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ImageData" , js_name = data ) ]
