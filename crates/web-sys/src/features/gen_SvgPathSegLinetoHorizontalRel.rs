...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPathSegLinetoHorizontalRel" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPathSegLinetoHorizontalRel" , js_name = x ) ]
