...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimationElement" , js_name = targetElement ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimationElement" , js_name = requiredFeatures ) ]
    ...
    #[cfg(feature = "SvgStringList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimationElement" , js_name = requiredExtensions ) ]
    ...
    #[cfg(feature = "SvgStringList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimationElement" , js_name = systemLanguage ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGAnimationElement" , js_name = beginElement ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGAnimationElement" , js_name = beginElementAt ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGAnimationElement" , js_name = endElement ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGAnimationElement" , js_name = endElementAt ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGAnimationElement" , js_name = getCurrentTime ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGAnimationElement" , js_name = getSimpleDuration ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGAnimationElement" , js_name = getStartTime ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGAnimationElement" , js_name = hasExtension ) ]
