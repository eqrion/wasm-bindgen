...
extern "C" {
    ...
    pub type GpuQueue;
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "GPUQueue" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , setter , js_class = "GPUQueue" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUQueue" , js_name = copyImageBitmapToTexture ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUQueue" , js_name = createFence ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "GpuFence")]
    # [ wasm_bindgen ( method , final , js_class = "GPUQueue" , js_name = signal ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUQueue" , js_name = submit ) ]
