...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ImageBitmap" , js_name = width ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ImageBitmap" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ImageBitmap" , js_name = close ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ImageBitmap" , js_name = findOptimalFormat ) ]
    ...
    #[cfg(feature = "ImageBitmapFormat")]
    # [ wasm_bindgen ( catch , method , final , js_class = "ImageBitmap" , js_name = mapDataInto ) ]
    ...
    #[cfg(feature = "ImageBitmapFormat")]
    # [ wasm_bindgen ( catch , method , final , js_class = "ImageBitmap" , js_name = mappedDataLength ) ]
