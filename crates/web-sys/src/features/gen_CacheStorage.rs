...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "CacheStorage" , js_name = delete ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CacheStorage" , js_name = has ) ]
    #[doc = "The `has()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CacheStorage" , js_name = keys ) ]
    #[doc = "The `keys()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "Request")]
    # [ wasm_bindgen ( method , final , js_class = "CacheStorage" , js_name = match ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CacheStorage" , js_name = open ) ]
    #[doc = "The `open()` method."]
    #[doc = ""]
