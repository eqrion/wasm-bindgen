...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DynamicsCompressorNode" , js_name = threshold ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "DynamicsCompressorNode" , js_name = knee ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "DynamicsCompressorNode" , js_name = ratio ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DynamicsCompressorNode" , js_name = reduction ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "DynamicsCompressorNode" , js_name = attack ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "DynamicsCompressorNode" , js_name = release ) ]
