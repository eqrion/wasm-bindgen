...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedString" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGAnimatedString" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedString" , js_name = animVal ) ]
