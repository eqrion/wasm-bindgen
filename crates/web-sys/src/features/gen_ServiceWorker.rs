...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ServiceWorker" , js_name = scriptURL ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ServiceWorker" , js_name = state ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ServiceWorker" , js_name = onstatechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ServiceWorker" , js_name = onstatechange ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ServiceWorker" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ServiceWorker" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ServiceWorker" , js_name = postMessage ) ]
