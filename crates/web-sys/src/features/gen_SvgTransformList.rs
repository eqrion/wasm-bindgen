...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTransformList" , js_name = numberOfItems ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = appendItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = clear ) ]
    ...
    #[cfg(feature = "SvgTransform")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = consolidate ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGTransformList" , js_name = createSVGTransformFromMatrix ) ]
    ...
    #[cfg(feature = "SvgTransform")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = getItem ) ]
    ...
    #[cfg(feature = "SvgTransform")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = initialize ) ]
    ...
    #[cfg(feature = "SvgTransform")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = insertItemBefore ) ]
    ...
    #[cfg(feature = "SvgTransform")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = removeItem ) ]
    ...
    #[cfg(feature = "SvgTransform")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGTransformList" , js_name = replaceItem ) ]
