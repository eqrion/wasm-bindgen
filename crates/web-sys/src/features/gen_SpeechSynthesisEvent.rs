...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisEvent" , js_name = utterance ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisEvent" , js_name = charIndex ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisEvent" , js_name = charLength ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisEvent" , js_name = elapsedTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisEvent" , js_name = name ) ]
