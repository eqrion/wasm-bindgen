...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCIceCandidate" , js_name = candidate ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCIceCandidate" , js_name = candidate ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCIceCandidate" , js_name = sdpMid ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCIceCandidate" , js_name = sdpMid ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCIceCandidate" , js_name = sdpMLineIndex ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCIceCandidate" , js_name = sdpMLineIndex ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCIceCandidate" , js_name = toJSON ) ]
