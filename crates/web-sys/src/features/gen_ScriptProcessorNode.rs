...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ScriptProcessorNode" , js_name = onaudioprocess ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ScriptProcessorNode" , js_name = onaudioprocess ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ScriptProcessorNode" , js_name = bufferSize ) ]
