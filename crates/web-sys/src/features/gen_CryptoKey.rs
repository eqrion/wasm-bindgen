...
extern "C" {
    ...
    pub type CryptoKey;
    # [ wasm_bindgen ( final , method , getter , js_class = "CryptoKey" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CryptoKey" , js_name = extractable ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "CryptoKey" , js_name = algorithm ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CryptoKey" , js_name = usages ) ]
