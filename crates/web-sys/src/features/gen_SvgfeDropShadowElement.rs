...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = in1 ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = dx ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = dy ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = stdDeviationX ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = stdDeviationY ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = height ) ]
    ...
    #[cfg(feature = "SvgAnimatedString")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEDropShadowElement" , js_name = result ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGFEDropShadowElement" , js_name = setStdDeviation ) ]
