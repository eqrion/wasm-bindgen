...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioNode" , js_name = context ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioNode" , js_name = numberOfInputs ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioNode" , js_name = numberOfOutputs ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioNode" , js_name = channelCount ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioNode" , js_name = channelCount ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioNode" , js_name = channelCountMode ) ]
    ...
    #[cfg(feature = "ChannelCountMode")]
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioNode" , js_name = channelCountMode ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioNode" , js_name = channelInterpretation ) ]
    ...
    #[cfg(feature = "ChannelInterpretation")]
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioNode" , js_name = channelInterpretation ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioNode" , js_name = connect ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioNode" , js_name = disconnect ) ]
