...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaQueryList" , js_name = media ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaQueryList" , js_name = matches ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaQueryList" , js_name = onchange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MediaQueryList" , js_name = onchange ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaQueryList" , js_name = addListener ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaQueryList" , js_name = removeListener ) ]
