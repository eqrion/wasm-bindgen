...
extern "C" {
    ...
    pub type Clients;
    # [ wasm_bindgen ( method , final , js_class = "Clients" , js_name = claim ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Clients" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Clients" , js_name = matchAll ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Clients" , js_name = openWindow ) ]
