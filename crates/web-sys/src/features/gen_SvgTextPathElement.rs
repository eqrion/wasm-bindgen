...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTextPathElement" , js_name = startOffset ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTextPathElement" , js_name = method ) ]
    ...
    #[cfg(feature = "SvgAnimatedEnumeration")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTextPathElement" , js_name = spacing ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGTextPathElement" , js_name = href ) ]
