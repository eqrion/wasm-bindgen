...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DocumentFragment" , js_name = children ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "DocumentFragment" , js_name = firstElementChild ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "DocumentFragment" , js_name = lastElementChild ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DocumentFragment" , js_name = childElementCount ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "DocumentFragment" , js_name = getElementById ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( catch , method , final , js_class = "DocumentFragment" , js_name = querySelector ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DocumentFragment" , js_name = querySelectorAll ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , variadic , js_class = "DocumentFragment" , js_name = append ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DocumentFragment" , js_name = append ) ]
    #[doc = "The `append()` method."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/DocumentFragment/append)"]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , variadic , js_class = "DocumentFragment" , js_name = prepend ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DocumentFragment" , js_name = prepend ) ]
    #[doc = "The `prepend()` method."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/DocumentFragment/prepend)"]
    #[doc = ""]
