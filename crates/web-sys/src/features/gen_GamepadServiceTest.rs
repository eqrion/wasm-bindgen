...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadServiceTest" , js_name = noMapping ) ]
    ...
    #[cfg(feature = "GamepadMappingType")]
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadServiceTest" , js_name = standardMapping ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadServiceTest" , js_name = noHand ) ]
    ...
    #[cfg(feature = "GamepadHand")]
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadServiceTest" , js_name = leftHand ) ]
    ...
    #[cfg(feature = "GamepadHand")]
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadServiceTest" , js_name = rightHand ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "GamepadServiceTest" , js_name = addGamepad ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GamepadServiceTest" , js_name = newAxisMoveEvent ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GamepadServiceTest" , js_name = newButtonEvent ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GamepadServiceTest" , js_name = newButtonValueEvent ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GamepadServiceTest" , js_name = newPoseMove ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GamepadServiceTest" , js_name = removeGamepad ) ]
