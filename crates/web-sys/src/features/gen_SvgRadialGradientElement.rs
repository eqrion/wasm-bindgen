...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGRadialGradientElement" , js_name = cx ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGRadialGradientElement" , js_name = cy ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGRadialGradientElement" , js_name = r ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGRadialGradientElement" , js_name = fx ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGRadialGradientElement" , js_name = fy ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGRadialGradientElement" , js_name = fr ) ]
