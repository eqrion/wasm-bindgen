...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SharedWorkerGlobalScope" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SharedWorkerGlobalScope" , js_name = onconnect ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SharedWorkerGlobalScope" , js_name = onconnect ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SharedWorkerGlobalScope" , js_name = close ) ]
