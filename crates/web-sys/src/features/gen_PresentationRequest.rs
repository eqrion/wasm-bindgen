...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PresentationRequest" , js_name = onconnectionavailable ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "PresentationRequest" , js_name = onconnectionavailable ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PresentationRequest" , js_name = getAvailability ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PresentationRequest" , js_name = reconnect ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "PresentationRequest" , js_name = start ) ]
