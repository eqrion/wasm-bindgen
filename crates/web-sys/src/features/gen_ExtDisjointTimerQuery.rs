...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = beginQueryEXT ) ]
    ...
    #[cfg(feature = "WebGlQuery")]
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = createQueryEXT ) ]
    ...
    #[cfg(feature = "WebGlQuery")]
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = deleteQueryEXT ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = endQueryEXT ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = getQueryEXT ) ]
    ...
    #[cfg(feature = "WebGlQuery")]
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = getQueryObjectEXT ) ]
    ...
    #[cfg(feature = "WebGlQuery")]
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = isQueryEXT ) ]
    ...
    #[cfg(feature = "WebGlQuery")]
    # [ wasm_bindgen ( method , final , js_class = "EXT_disjoint_timer_query" , js_name = queryCounterEXT ) ]
