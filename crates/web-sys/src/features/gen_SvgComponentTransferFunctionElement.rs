...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = tableValues ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = slope ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = intercept ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = amplitude ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = exponent ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGComponentTransferFunctionElement" , js_name = offset ) ]
