...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "OES_vertex_array_object" , js_name = bindVertexArrayOES ) ]
    ...
    #[cfg(feature = "WebGlVertexArrayObject")]
    # [ wasm_bindgen ( method , final , js_class = "OES_vertex_array_object" , js_name = createVertexArrayOES ) ]
    ...
    #[cfg(feature = "WebGlVertexArrayObject")]
    # [ wasm_bindgen ( method , final , js_class = "OES_vertex_array_object" , js_name = deleteVertexArrayOES ) ]
    ...
    #[cfg(feature = "WebGlVertexArrayObject")]
    # [ wasm_bindgen ( method , final , js_class = "OES_vertex_array_object" , js_name = isVertexArrayOES ) ]
