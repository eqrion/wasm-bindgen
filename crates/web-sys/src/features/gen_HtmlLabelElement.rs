...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLabelElement" , js_name = form ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLabelElement" , js_name = htmlFor ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLLabelElement" , js_name = htmlFor ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLLabelElement" , js_name = control ) ]
