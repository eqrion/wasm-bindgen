...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoPlaybackQuality" , js_name = creationTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoPlaybackQuality" , js_name = totalVideoFrames ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoPlaybackQuality" , js_name = droppedVideoFrames ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoPlaybackQuality" , js_name = corruptedVideoFrames ) ]
