...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessageEvent" , js_name = data ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessageEvent" , js_name = origin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessageEvent" , js_name = lastEventId ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessageEvent" , js_name = source ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessageEvent" , js_name = ports ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MessageEvent" , js_name = initMessageEvent ) ]
