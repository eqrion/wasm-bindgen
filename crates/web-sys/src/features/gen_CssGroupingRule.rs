...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSGroupingRule" , js_name = cssRules ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSGroupingRule" , js_name = deleteRule ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CSSGroupingRule" , js_name = insertRule ) ]
