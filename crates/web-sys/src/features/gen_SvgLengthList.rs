...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGLengthList" , js_name = numberOfItems ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = appendItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = clear ) ]
    ...
    #[cfg(feature = "SvgLength")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = getItem ) ]
    ...
    #[cfg(feature = "SvgLength")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = initialize ) ]
    ...
    #[cfg(feature = "SvgLength")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = insertItemBefore ) ]
    ...
    #[cfg(feature = "SvgLength")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = removeItem ) ]
    ...
    #[cfg(feature = "SvgLength")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGLengthList" , js_name = replaceItem ) ]
