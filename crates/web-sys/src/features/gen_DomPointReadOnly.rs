...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMPointReadOnly" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMPointReadOnly" , js_name = y ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMPointReadOnly" , js_name = z ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMPointReadOnly" , js_name = w ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "DOMPointReadOnly" , js_name = toJSON ) ]
