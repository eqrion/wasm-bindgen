...
extern "C" {
    ...
    pub type Storage;
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "Storage" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Storage" , js_name = clear ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Storage" , js_name = getItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Storage" , js_name = removeItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Storage" , js_name = setItem ) ]
