...
extern "C" {
    ...
    #[cfg(web_sys_unstable_apis)]
    #[cfg(feature = "XrEye")]
    # [ wasm_bindgen ( final , method , getter , js_class = "XRView" , js_name = eye ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "XRView" , js_name = projectionMatrix ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "XRView" , js_name = transform ) ]
