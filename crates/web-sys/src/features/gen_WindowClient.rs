...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WindowClient" , js_name = visibilityState ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WindowClient" , js_name = focused ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "WindowClient" , js_name = focus ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "WindowClient" , js_name = navigate ) ]
