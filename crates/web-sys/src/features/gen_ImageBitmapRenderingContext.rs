...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "ImageBitmapRenderingContext" , js_name = transferFromImageBitmap ) ]
    ...
    #[cfg(feature = "ImageBitmap")]
    # [ wasm_bindgen ( method , final , js_class = "ImageBitmapRenderingContext" , js_name = transferImageBitmap ) ]
