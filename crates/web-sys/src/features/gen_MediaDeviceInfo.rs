...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaDeviceInfo" , js_name = deviceId ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaDeviceInfo" , js_name = kind ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaDeviceInfo" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaDeviceInfo" , js_name = groupId ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaDeviceInfo" , js_name = toJSON ) ]
