...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = kind ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = language ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = id ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = inBandMetadataTrackDispatchType ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = mode ) ]
    ...
    #[cfg(feature = "TextTrackMode")]
    # [ wasm_bindgen ( final , method , setter , js_class = "TextTrack" , js_name = mode ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = cues ) ]
    ...
    #[cfg(feature = "TextTrackCueList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = activeCues ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextTrack" , js_name = oncuechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "TextTrack" , js_name = oncuechange ) ]
    ...
    #[cfg(feature = "VttCue")]
    # [ wasm_bindgen ( method , final , js_class = "TextTrack" , js_name = addCue ) ]
    ...
    #[cfg(feature = "VttCue")]
    # [ wasm_bindgen ( catch , method , final , js_class = "TextTrack" , js_name = removeCue ) ]
