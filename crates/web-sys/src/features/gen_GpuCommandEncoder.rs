...
extern "C" {
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "GPUCommandEncoder" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , setter , js_class = "GPUCommandEncoder" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = beginComputePass ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = beginRenderPass ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = copyBufferToBuffer ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = copyBufferToTexture ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    #[cfg(all(feature = "GpuBufferCopyView", feature = "GpuTextureCopyView",))]
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = copyTextureToBuffer ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = copyTextureToTexture ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = finish ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = insertDebugMarker ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = popDebugGroup ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = pushDebugGroup ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUCommandEncoder" , js_name = resolveQuerySet ) ]
