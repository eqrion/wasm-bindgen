...
extern "C" {
    ...
    pub type VideoTrack;
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoTrack" , js_name = id ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoTrack" , js_name = kind ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoTrack" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoTrack" , js_name = language ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VideoTrack" , js_name = selected ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "VideoTrack" , js_name = selected ) ]
