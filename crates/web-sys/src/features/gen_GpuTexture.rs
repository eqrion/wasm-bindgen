...
extern "C" {
    ...
    pub type GpuTexture;
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "GPUTexture" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , setter , js_class = "GPUTexture" , js_name = label ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GPUTexture" , js_name = createView ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUTexture" , js_name = destroy ) ]
