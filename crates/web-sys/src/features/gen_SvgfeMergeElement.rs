...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMergeElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMergeElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMergeElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMergeElement" , js_name = height ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMergeElement" , js_name = result ) ]
