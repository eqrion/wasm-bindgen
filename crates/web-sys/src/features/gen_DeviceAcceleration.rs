...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceAcceleration" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceAcceleration" , js_name = y ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceAcceleration" , js_name = z ) ]
