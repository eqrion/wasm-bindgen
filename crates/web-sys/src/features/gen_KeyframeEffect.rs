...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "KeyframeEffect" , js_name = target ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "KeyframeEffect" , js_name = target ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "KeyframeEffect" , js_name = iterationComposite ) ]
    ...
    #[cfg(feature = "IterationCompositeOperation")]
    # [ wasm_bindgen ( final , method , setter , js_class = "KeyframeEffect" , js_name = iterationComposite ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "KeyframeEffect" , js_name = composite ) ]
    ...
    #[cfg(feature = "CompositeOperation")]
    # [ wasm_bindgen ( final , method , setter , js_class = "KeyframeEffect" , js_name = composite ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "KeyframeEffect" , js_name = getKeyframes ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "KeyframeEffect" , js_name = setKeyframes ) ]
