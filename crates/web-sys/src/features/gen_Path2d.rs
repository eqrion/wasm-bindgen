...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = addPath ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Path2D" , js_name = arc ) ]
    #[doc = "The `arc()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Path2D" , js_name = arcTo ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = bezierCurveTo ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = closePath ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Path2D" , js_name = ellipse ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = lineTo ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = moveTo ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = quadraticCurveTo ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Path2D" , js_name = rect ) ]
    #[doc = "The `rect()` method."]
    #[doc = ""]
