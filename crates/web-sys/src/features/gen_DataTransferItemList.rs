...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DataTransferItemList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DataTransferItemList" , js_name = add ) ]
    #[doc = "The `add()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DataTransferItemList" , js_name = clear ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DataTransferItemList" , js_name = remove ) ]
