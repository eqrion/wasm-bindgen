...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceNavigation" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceNavigation" , js_name = redirectCount ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "PerformanceNavigation" , js_name = toJSON ) ]
