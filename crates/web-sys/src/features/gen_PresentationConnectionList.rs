...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PresentationConnectionList" , js_name = connections ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PresentationConnectionList" , js_name = onconnectionavailable ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "PresentationConnectionList" , js_name = onconnectionavailable ) ]
