...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "XRFrame" , js_name = session ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "XRFrame" , js_name = getPose ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "XRFrame" , js_name = getViewerPose ) ]
