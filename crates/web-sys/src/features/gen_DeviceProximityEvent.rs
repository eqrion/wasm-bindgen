...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceProximityEvent" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceProximityEvent" , js_name = min ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceProximityEvent" , js_name = max ) ]
