...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLUListElement" , js_name = compact ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLUListElement" , js_name = compact ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLUListElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLUListElement" , js_name = type ) ]
