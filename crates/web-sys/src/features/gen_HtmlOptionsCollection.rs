...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLOptionsCollection" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLOptionsCollection" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "HTMLOptionsCollection" , js_name = selectedIndex ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , setter , js_class = "HTMLOptionsCollection" , js_name = selectedIndex ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "HTMLOptionsCollection" , js_name = add ) ]
    #[doc = "The `add()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "HTMLOptionsCollection" , js_name = remove ) ]
