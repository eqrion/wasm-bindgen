...
extern "C" {
    ...
    pub type MediaKeys;
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeys" , js_name = keySystem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaKeys" , js_name = createSession ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeys" , js_name = getStatusForPolicy ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeys" , js_name = setServerCertificate ) ]
