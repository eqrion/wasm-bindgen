...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceRotationRate" , js_name = alpha ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceRotationRate" , js_name = beta ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DeviceRotationRate" , js_name = gamma ) ]
