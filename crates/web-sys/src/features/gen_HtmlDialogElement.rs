...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLDialogElement" , js_name = open ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLDialogElement" , js_name = open ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLDialogElement" , js_name = returnValue ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLDialogElement" , js_name = returnValue ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "HTMLDialogElement" , js_name = close ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "HTMLDialogElement" , js_name = show ) ]
    #[doc = "The `show()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "HTMLDialogElement" , js_name = showModal ) ]
