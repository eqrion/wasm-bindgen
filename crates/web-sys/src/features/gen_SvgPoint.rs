...
extern "C" {
    ...
    pub type SvgPoint;
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPoint" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPoint" , js_name = x ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPoint" , js_name = y ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPoint" , js_name = y ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGPoint" , js_name = matrixTransform ) ]
