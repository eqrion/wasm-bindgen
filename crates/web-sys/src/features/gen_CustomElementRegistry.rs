...
extern "C" {
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CustomElementRegistry" , js_name = define ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "CustomElementRegistry" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( method , final , js_class = "CustomElementRegistry" , js_name = upgrade ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "CustomElementRegistry" , js_name = whenDefined ) ]
