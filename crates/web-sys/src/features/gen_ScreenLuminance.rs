...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ScreenLuminance" , js_name = min ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ScreenLuminance" , js_name = max ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ScreenLuminance" , js_name = maxAverage ) ]
