...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMaskElement" , js_name = maskUnits ) ]
    ...
    #[cfg(feature = "SvgAnimatedEnumeration")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMaskElement" , js_name = maskContentUnits ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMaskElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMaskElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMaskElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGMaskElement" , js_name = height ) ]
