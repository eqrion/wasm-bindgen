...
extern "C" {
    ...
    pub type MediaList;
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaList" , js_name = mediaText ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MediaList" , js_name = mediaText ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaList" , js_name = appendMedium ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaList" , js_name = deleteMedium ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaList" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
