...
extern "C" {
    ...
    #[cfg(feature = "VrEye")]
    # [ wasm_bindgen ( method , final , js_class = "VRMockDisplay" , js_name = setEyeParameter ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockDisplay" , js_name = setEyeResolution ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockDisplay" , js_name = setMountState ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockDisplay" , js_name = setPose ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "VRMockDisplay" , js_name = update ) ]
