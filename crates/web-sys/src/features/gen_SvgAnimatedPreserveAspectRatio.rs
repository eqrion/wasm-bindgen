...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedPreserveAspectRatio" , js_name = baseVal ) ]
    ...
    #[cfg(feature = "SvgPreserveAspectRatio")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedPreserveAspectRatio" , js_name = animVal ) ]
