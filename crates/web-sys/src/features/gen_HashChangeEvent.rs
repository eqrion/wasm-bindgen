...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HashChangeEvent" , js_name = oldURL ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HashChangeEvent" , js_name = newURL ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "HashChangeEvent" , js_name = initHashChangeEvent ) ]
