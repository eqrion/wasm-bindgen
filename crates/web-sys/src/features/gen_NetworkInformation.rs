...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "NetworkInformation" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "NetworkInformation" , js_name = ontypechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "NetworkInformation" , js_name = ontypechange ) ]
