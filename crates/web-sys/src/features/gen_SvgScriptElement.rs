...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGScriptElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGScriptElement" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGScriptElement" , js_name = crossOrigin ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGScriptElement" , js_name = crossOrigin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGScriptElement" , js_name = href ) ]
