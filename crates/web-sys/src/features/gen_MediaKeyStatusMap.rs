...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeyStatusMap" , js_name = size ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MediaKeyStatusMap" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeyStatusMap" , js_name = has ) ]
    #[doc = "The `has()` method."]
    #[doc = ""]
