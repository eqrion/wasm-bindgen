...
extern "C" {
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserver" , js_name = root ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserver" , js_name = rootMargin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IntersectionObserver" , js_name = thresholds ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "IntersectionObserver" , js_name = disconnect ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "IntersectionObserver" , js_name = observe ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "IntersectionObserver" , js_name = takeRecords ) ]
    ...
    #[cfg(feature = "Element")]
    # [ wasm_bindgen ( method , final , js_class = "IntersectionObserver" , js_name = unobserve ) ]
