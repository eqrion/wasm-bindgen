...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGNumberList" , js_name = numberOfItems ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = appendItem ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = clear ) ]
    ...
    #[cfg(feature = "SvgNumber")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = getItem ) ]
    ...
    #[cfg(feature = "SvgNumber")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = initialize ) ]
    ...
    #[cfg(feature = "SvgNumber")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = insertItemBefore ) ]
    ...
    #[cfg(feature = "SvgNumber")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = removeItem ) ]
    ...
    #[cfg(feature = "SvgNumber")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGNumberList" , js_name = replaceItem ) ]
