...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceEntry" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceEntry" , js_name = entryType ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceEntry" , js_name = startTime ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "PerformanceEntry" , js_name = duration ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "PerformanceEntry" , js_name = toJSON ) ]
