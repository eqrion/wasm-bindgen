...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "NamedNodeMap" , js_name = length ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( method , final , js_class = "NamedNodeMap" , js_name = getNamedItem ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( method , final , js_class = "NamedNodeMap" , js_name = getNamedItemNS ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( method , final , js_class = "NamedNodeMap" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , final , js_class = "NamedNodeMap" , js_name = removeNamedItem ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , final , js_class = "NamedNodeMap" , js_name = removeNamedItemNS ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , final , js_class = "NamedNodeMap" , js_name = setNamedItem ) ]
    ...
    #[cfg(feature = "Attr")]
    # [ wasm_bindgen ( catch , method , final , js_class = "NamedNodeMap" , js_name = setNamedItemNS ) ]
