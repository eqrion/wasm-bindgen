...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "MutationObserver" , js_name = disconnect ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "MutationObserver" , js_name = observe ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MutationObserver" , js_name = takeRecords ) ]
