...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ConstantSourceNode" , js_name = offset ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ConstantSourceNode" , js_name = onended ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ConstantSourceNode" , js_name = onended ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ConstantSourceNode" , js_name = start ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "ConstantSourceNode" , js_name = stop ) ]
    #[doc = "The `stop()` method."]
    #[doc = ""]
