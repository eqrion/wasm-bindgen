...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedTransformList" , js_name = baseVal ) ]
    ...
    #[cfg(feature = "SvgTransformList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedTransformList" , js_name = animVal ) ]
