...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGForeignObjectElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGForeignObjectElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGForeignObjectElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGForeignObjectElement" , js_name = height ) ]
