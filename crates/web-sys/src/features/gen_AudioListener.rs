...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioListener" , js_name = dopplerFactor ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioListener" , js_name = dopplerFactor ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioListener" , js_name = speedOfSound ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioListener" , js_name = speedOfSound ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "AudioListener" , js_name = setOrientation ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "AudioListener" , js_name = setPosition ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "AudioListener" , js_name = setVelocity ) ]
