...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCTrackEvent" , js_name = receiver ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCTrackEvent" , js_name = track ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCTrackEvent" , js_name = streams ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCTrackEvent" , js_name = transceiver ) ]
