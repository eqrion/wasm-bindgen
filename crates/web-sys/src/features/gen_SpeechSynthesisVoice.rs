...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisVoice" , js_name = voiceURI ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisVoice" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisVoice" , js_name = lang ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisVoice" , js_name = localService ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechSynthesisVoice" , js_name = default ) ]
