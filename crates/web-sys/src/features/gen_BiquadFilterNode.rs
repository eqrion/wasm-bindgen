...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "BiquadFilterNode" , js_name = type ) ]
    ...
    #[cfg(feature = "BiquadFilterType")]
    # [ wasm_bindgen ( final , method , setter , js_class = "BiquadFilterNode" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "BiquadFilterNode" , js_name = frequency ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "BiquadFilterNode" , js_name = detune ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "BiquadFilterNode" , js_name = Q ) ]
    ...
    #[cfg(feature = "AudioParam")]
    # [ wasm_bindgen ( final , method , getter , js_class = "BiquadFilterNode" , js_name = gain ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "BiquadFilterNode" , js_name = getFrequencyResponse ) ]
