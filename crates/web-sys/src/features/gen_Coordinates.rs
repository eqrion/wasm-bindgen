...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = latitude ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = longitude ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = altitude ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = accuracy ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = altitudeAccuracy ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = heading ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Coordinates" , js_name = speed ) ]
