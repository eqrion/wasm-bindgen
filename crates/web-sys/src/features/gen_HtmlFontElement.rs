...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLFontElement" , js_name = color ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLFontElement" , js_name = color ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLFontElement" , js_name = face ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLFontElement" , js_name = face ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLFontElement" , js_name = size ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLFontElement" , js_name = size ) ]
