...
extern "C" {
    ...
    pub type Text;
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "Text" , js_name = wholeText ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Text" , js_name = assignedSlot ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Text" , js_name = splitText ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Text" , js_name = convertPointFromNode ) ]
    ...
    #[cfg(feature = "DomQuad")]
    # [ wasm_bindgen ( catch , method , final , js_class = "Text" , js_name = convertQuadFromNode ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Text" , js_name = convertRectFromNode ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Text" , js_name = getBoxQuads ) ]
