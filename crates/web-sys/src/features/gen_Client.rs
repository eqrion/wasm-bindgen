...
extern "C" {
    ...
    pub type Client;
    # [ wasm_bindgen ( final , method , getter , js_class = "Client" , js_name = url ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Client" , js_name = frameType ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Client" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Client" , js_name = id ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Client" , js_name = postMessage ) ]
