...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextDecoder" , js_name = encoding ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TextDecoder" , js_name = fatal ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "TextDecoder" , js_name = decode ) ]
