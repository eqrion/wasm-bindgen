...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessagePort" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MessagePort" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MessagePort" , js_name = onmessageerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MessagePort" , js_name = onmessageerror ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MessagePort" , js_name = close ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "MessagePort" , js_name = postMessage ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MessagePort" , js_name = start ) ]
