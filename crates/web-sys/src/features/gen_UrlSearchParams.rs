...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "URLSearchParams" , js_name = append ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "URLSearchParams" , js_name = delete ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "URLSearchParams" , js_name = get ) ]
    #[doc = "The `get()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "URLSearchParams" , js_name = getAll ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "URLSearchParams" , js_name = has ) ]
    #[doc = "The `has()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "URLSearchParams" , js_name = set ) ]
    #[doc = "The `set()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "URLSearchParams" , js_name = sort ) ]
    #[doc = "The `sort()` method."]
    #[doc = ""]
