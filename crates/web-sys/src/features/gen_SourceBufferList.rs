...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SourceBufferList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SourceBufferList" , js_name = onaddsourcebuffer ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SourceBufferList" , js_name = onaddsourcebuffer ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SourceBufferList" , js_name = onremovesourcebuffer ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SourceBufferList" , js_name = onremovesourcebuffer ) ]
