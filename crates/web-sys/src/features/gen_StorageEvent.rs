...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "StorageEvent" , js_name = key ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "StorageEvent" , js_name = oldValue ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "StorageEvent" , js_name = newValue ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "StorageEvent" , js_name = url ) ]
    ...
    #[cfg(feature = "Storage")]
    # [ wasm_bindgen ( final , method , getter , js_class = "StorageEvent" , js_name = storageArea ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "StorageEvent" , js_name = initStorageEvent ) ]
