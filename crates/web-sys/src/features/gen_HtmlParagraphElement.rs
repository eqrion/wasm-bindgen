...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLParagraphElement" , js_name = align ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLParagraphElement" , js_name = align ) ]
