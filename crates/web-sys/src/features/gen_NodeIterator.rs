...
extern "C" {
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "NodeIterator" , js_name = root ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( final , method , getter , js_class = "NodeIterator" , js_name = referenceNode ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "NodeIterator" , js_name = pointerBeforeReferenceNode ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "NodeIterator" , js_name = whatToShow ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "NodeIterator" , js_name = filter ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "NodeIterator" , js_name = detach ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "NodeIterator" , js_name = nextNode ) ]
    ...
    #[cfg(feature = "Node")]
    # [ wasm_bindgen ( catch , method , final , js_class = "NodeIterator" , js_name = previousNode ) ]
