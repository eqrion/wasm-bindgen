...
extern "C" {
    ...
    pub type Directory;
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "Directory" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "Directory" , js_name = path ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Directory" , js_name = getFiles ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Directory" , js_name = getFilesAndDirectories ) ]
