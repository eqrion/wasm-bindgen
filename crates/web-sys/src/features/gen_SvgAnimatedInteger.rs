...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedInteger" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGAnimatedInteger" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedInteger" , js_name = animVal ) ]
