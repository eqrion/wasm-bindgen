...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBOpenDBRequest" , js_name = onblocked ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "IDBOpenDBRequest" , js_name = onblocked ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBOpenDBRequest" , js_name = onupgradeneeded ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "IDBOpenDBRequest" , js_name = onupgradeneeded ) ]
