...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCDTMFSender" , js_name = ontonechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "RTCDTMFSender" , js_name = ontonechange ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCDTMFSender" , js_name = toneBuffer ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCDTMFSender" , js_name = insertDTMF ) ]
