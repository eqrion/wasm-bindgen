...
extern "C" {
    ...
    #[deprecated(note = "doesn't exist in Safari, use parent class methods instead")]
    # [ wasm_bindgen ( final , method , getter , js_class = "AudioScheduledSourceNode" , js_name = onended ) ]
    ...
    #[deprecated(note = "doesn't exist in Safari, use parent class methods instead")]
    # [ wasm_bindgen ( final , method , setter , js_class = "AudioScheduledSourceNode" , js_name = onended ) ]
    ...
    #[deprecated(note = "doesn't exist in Safari, use parent class methods instead")]
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioScheduledSourceNode" , js_name = start ) ]
    ...
    #[deprecated(note = "doesn't exist in Safari, use parent class methods instead")]
    # [ wasm_bindgen ( catch , method , final , js_class = "AudioScheduledSourceNode" , js_name = stop ) ]
    #[doc = "The `stop()` method."]
    #[doc = ""]
