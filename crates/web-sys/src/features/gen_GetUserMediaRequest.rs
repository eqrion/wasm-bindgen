...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = windowID ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = innerWindowID ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = callID ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = rawID ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = mediaSource ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = isSecure ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GetUserMediaRequest" , js_name = isHandlingUserInput ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "GetUserMediaRequest" , js_name = getConstraints ) ]
