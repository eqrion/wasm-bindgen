...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGraphicsElement" , js_name = transform ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGraphicsElement" , js_name = nearestViewportElement ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGraphicsElement" , js_name = farthestViewportElement ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGraphicsElement" , js_name = requiredFeatures ) ]
    ...
    #[cfg(feature = "SvgStringList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGraphicsElement" , js_name = requiredExtensions ) ]
    ...
    #[cfg(feature = "SvgStringList")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGGraphicsElement" , js_name = systemLanguage ) ]
    ...
    #[cfg(feature = "SvgRect")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGGraphicsElement" , js_name = getBBox ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGGraphicsElement" , js_name = getCTM ) ]
    ...
    #[cfg(feature = "SvgMatrix")]
    # [ wasm_bindgen ( method , final , js_class = "SVGGraphicsElement" , js_name = getScreenCTM ) ]
    ...
    #[cfg(feature = "SvgMatrix")]
    # [ wasm_bindgen ( catch , method , final , js_class = "SVGGraphicsElement" , js_name = getTransformToElement ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "SVGGraphicsElement" , js_name = hasExtension ) ]
