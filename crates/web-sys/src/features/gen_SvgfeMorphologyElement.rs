...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = in1 ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = operator ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = radiusX ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = radiusY ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = height ) ]
    ...
    #[cfg(feature = "SvgAnimatedString")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEMorphologyElement" , js_name = result ) ]
