...
extern "C" {
    ...
    pub type GpuFence;
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , getter , js_class = "GPUFence" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( final , method , setter , js_class = "GPUFence" , js_name = label ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUFence" , js_name = getCompletedValue ) ]
    ...
    #[cfg(web_sys_unstable_apis)]
    # [ wasm_bindgen ( method , final , js_class = "GPUFence" , js_name = onCompletion ) ]
