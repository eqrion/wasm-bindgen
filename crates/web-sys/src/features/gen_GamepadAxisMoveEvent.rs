...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadAxisMoveEvent" , js_name = axis ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "GamepadAxisMoveEvent" , js_name = value ) ]
