...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedBoolean" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGAnimatedBoolean" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedBoolean" , js_name = animVal ) ]
