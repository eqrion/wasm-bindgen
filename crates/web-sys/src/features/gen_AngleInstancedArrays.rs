...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "ANGLE_instanced_arrays" , js_name = drawArraysInstancedANGLE ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ANGLE_instanced_arrays" , js_name = drawElementsInstancedANGLE ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "ANGLE_instanced_arrays" , js_name = vertexAttribDivisorANGLE ) ]
