...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ConvolverNode" , js_name = buffer ) ]
    ...
    #[cfg(feature = "AudioBuffer")]
    # [ wasm_bindgen ( final , method , setter , js_class = "ConvolverNode" , js_name = buffer ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ConvolverNode" , js_name = normalize ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "ConvolverNode" , js_name = normalize ) ]
