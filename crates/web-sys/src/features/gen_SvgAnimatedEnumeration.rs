...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedEnumeration" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGAnimatedEnumeration" , js_name = baseVal ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGAnimatedEnumeration" , js_name = animVal ) ]
