...
extern "C" {
    ...
    # [ wasm_bindgen ( method , final , js_class = "PerformanceObserverEntryList" , js_name = getEntries ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "PerformanceObserverEntryList" , js_name = getEntriesByName ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "PerformanceObserverEntryList" , js_name = getEntriesByType ) ]
