...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DataTransferItem" , js_name = kind ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DataTransferItem" , js_name = type ) ]
    ...
    #[cfg(feature = "File")]
    # [ wasm_bindgen ( catch , method , final , js_class = "DataTransferItem" , js_name = getAsFile ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DataTransferItem" , js_name = getAsString ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DataTransferItem" , js_name = webkitGetAsEntry ) ]
