...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpSender" , js_name = track ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "RTCRtpSender" , js_name = dtmf ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpSender" , js_name = getParameters ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpSender" , js_name = getStats ) ]
    ...
    #[cfg(feature = "MediaStreamTrack")]
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpSender" , js_name = replaceTrack ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "RTCRtpSender" , js_name = setParameters ) ]
