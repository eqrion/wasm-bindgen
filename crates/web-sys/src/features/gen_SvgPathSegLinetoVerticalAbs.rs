...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGPathSegLinetoVerticalAbs" , js_name = y ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "SVGPathSegLinetoVerticalAbs" , js_name = y ) ]
