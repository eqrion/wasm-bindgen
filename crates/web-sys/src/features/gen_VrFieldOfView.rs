...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRFieldOfView" , js_name = upDegrees ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRFieldOfView" , js_name = rightDegrees ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRFieldOfView" , js_name = downDegrees ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRFieldOfView" , js_name = leftDegrees ) ]
