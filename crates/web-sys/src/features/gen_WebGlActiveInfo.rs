...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WebGLActiveInfo" , js_name = size ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WebGLActiveInfo" , js_name = type ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WebGLActiveInfo" , js_name = name ) ]
