...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Performance" , js_name = timeOrigin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Performance" , js_name = timing ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Performance" , js_name = navigation ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Performance" , js_name = onresourcetimingbufferfull ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "Performance" , js_name = onresourcetimingbufferfull ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = clearMarks ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = clearMeasures ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = clearResourceTimings ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = getEntries ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = getEntriesByName ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = getEntriesByType ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Performance" , js_name = mark ) ]
    #[doc = "The `mark()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "Performance" , js_name = measure ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = now ) ]
    #[doc = "The `now()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = setResourceTimingBufferSize ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "Performance" , js_name = toJSON ) ]
