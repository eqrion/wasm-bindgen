...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = error ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = sessionId ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = expiration ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = closed ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = keyStatuses ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = onkeystatuseschange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MediaKeySession" , js_name = onkeystatuseschange ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MediaKeySession" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MediaKeySession" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySession" , js_name = close ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySession" , js_name = generateRequest ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySession" , js_name = load ) ]
    #[doc = "The `load()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySession" , js_name = remove ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "MediaKeySession" , js_name = update ) ]
