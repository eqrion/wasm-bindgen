...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TCPServerSocket" , js_name = localPort ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TCPServerSocket" , js_name = onconnect ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "TCPServerSocket" , js_name = onconnect ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "TCPServerSocket" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "TCPServerSocket" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "TCPServerSocket" , js_name = close ) ]
