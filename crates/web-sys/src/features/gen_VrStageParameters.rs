...
extern "C" {
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "VRStageParameters" , js_name = sittingToStandingTransform ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRStageParameters" , js_name = sizeX ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "VRStageParameters" , js_name = sizeZ ) ]
