...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLBaseElement" , js_name = href ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLBaseElement" , js_name = href ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLBaseElement" , js_name = target ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLBaseElement" , js_name = target ) ]
