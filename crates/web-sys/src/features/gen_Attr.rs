...
extern "C" {
    ...
    pub type Attr;
    # [ wasm_bindgen ( final , method , getter , js_class = "Attr" , js_name = localName ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Attr" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "Attr" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Attr" , js_name = name ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Attr" , js_name = namespaceURI ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Attr" , js_name = prefix ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "Attr" , js_name = specified ) ]
