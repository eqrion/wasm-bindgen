...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "EventSource" , js_name = url ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "EventSource" , js_name = withCredentials ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "EventSource" , js_name = readyState ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "EventSource" , js_name = onopen ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "EventSource" , js_name = onopen ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "EventSource" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "EventSource" , js_name = onmessage ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "EventSource" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "EventSource" , js_name = onerror ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "EventSource" , js_name = close ) ]
