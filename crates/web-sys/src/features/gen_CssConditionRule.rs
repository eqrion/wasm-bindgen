...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CSSConditionRule" , js_name = conditionText ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "CSSConditionRule" , js_name = conditionText ) ]
