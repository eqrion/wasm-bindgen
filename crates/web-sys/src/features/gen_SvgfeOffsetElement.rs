...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = in1 ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = dx ) ]
    ...
    #[cfg(feature = "SvgAnimatedNumber")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = dy ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = height ) ]
    ...
    #[cfg(feature = "SvgAnimatedString")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFEOffsetElement" , js_name = result ) ]
