...
extern "C" {
    ...
    pub type WheelEvent;
    # [ wasm_bindgen ( final , method , getter , js_class = "WheelEvent" , js_name = deltaX ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WheelEvent" , js_name = deltaY ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WheelEvent" , js_name = deltaZ ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WheelEvent" , js_name = deltaMode ) ]
