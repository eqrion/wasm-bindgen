...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechRecognitionEvent" , js_name = resultIndex ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechRecognitionEvent" , js_name = results ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechRecognitionEvent" , js_name = interpretation ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SpeechRecognitionEvent" , js_name = emma ) ]
