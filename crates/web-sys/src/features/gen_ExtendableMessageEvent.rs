...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ExtendableMessageEvent" , js_name = data ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ExtendableMessageEvent" , js_name = origin ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ExtendableMessageEvent" , js_name = lastEventId ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ExtendableMessageEvent" , js_name = source ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "ExtendableMessageEvent" , js_name = ports ) ]
