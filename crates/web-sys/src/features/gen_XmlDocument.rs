...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "XMLDocument" , js_name = async ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "XMLDocument" , js_name = async ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "XMLDocument" , js_name = load ) ]
    #[doc = "The `load()` method."]
    #[doc = ""]
