...
extern "C" {
    ...
    pub type IdbCursor;
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBCursor" , js_name = source ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "IDBCursor" , js_name = direction ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "IDBCursor" , js_name = key ) ]
    ...
    # [ wasm_bindgen ( final , catch , method , getter , js_class = "IDBCursor" , js_name = primaryKey ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBCursor" , js_name = advance ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBCursor" , js_name = continue ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBCursor" , js_name = continuePrimaryKey ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBCursor" , js_name = delete ) ]
    ...
    #[cfg(feature = "IdbRequest")]
    # [ wasm_bindgen ( catch , method , final , js_class = "IDBCursor" , js_name = update ) ]
