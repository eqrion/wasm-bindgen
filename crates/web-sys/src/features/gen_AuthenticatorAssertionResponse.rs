...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AuthenticatorAssertionResponse" , js_name = authenticatorData ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AuthenticatorAssertionResponse" , js_name = signature ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "AuthenticatorAssertionResponse" , js_name = userHandle ) ]
