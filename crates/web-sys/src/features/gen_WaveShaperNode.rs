...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WaveShaperNode" , js_name = curve ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "WaveShaperNode" , js_name = curve ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "WaveShaperNode" , js_name = oversample ) ]
    ...
    #[cfg(feature = "OverSampleType")]
    # [ wasm_bindgen ( final , method , setter , js_class = "WaveShaperNode" , js_name = oversample ) ]
