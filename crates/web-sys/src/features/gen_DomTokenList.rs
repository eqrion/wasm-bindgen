...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMTokenList" , js_name = length ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "DOMTokenList" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "DOMTokenList" , js_name = value ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , variadic , js_class = "DOMTokenList" , js_name = add ) ]
    #[doc = "The `add()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMTokenList" , js_name = add ) ]
    #[doc = "The `add()` method."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/DOMTokenList/add)"]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( method , final , js_class = "DOMTokenList" , js_name = contains ) ]
    ...
    # [ wasm_bindgen ( method , final , js_class = "DOMTokenList" , js_name = item ) ]
    #[doc = "The `item()` method."]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , variadic , js_class = "DOMTokenList" , js_name = remove ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMTokenList" , js_name = remove ) ]
    #[doc = "The `remove()` method."]
    #[doc = ""]
    #[doc = "[MDN Documentation](https://developer.mozilla.org/en-US/docs/Web/API/DOMTokenList/remove)"]
    #[doc = ""]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMTokenList" , js_name = replace ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMTokenList" , js_name = supports ) ]
    ...
    # [ wasm_bindgen ( catch , method , final , js_class = "DOMTokenList" , js_name = toggle ) ]
