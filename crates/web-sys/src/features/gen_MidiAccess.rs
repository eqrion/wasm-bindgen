...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MIDIAccess" , js_name = inputs ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MIDIAccess" , js_name = outputs ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MIDIAccess" , js_name = onstatechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "MIDIAccess" , js_name = onstatechange ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "MIDIAccess" , js_name = sysexEnabled ) ]
