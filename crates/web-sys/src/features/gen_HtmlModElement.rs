...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLModElement" , js_name = cite ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLModElement" , js_name = cite ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "HTMLModElement" , js_name = dateTime ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "HTMLModElement" , js_name = dateTime ) ]
