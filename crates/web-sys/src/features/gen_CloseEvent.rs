...
extern "C" {
    ...
    pub type CloseEvent;
    # [ wasm_bindgen ( final , method , getter , js_class = "CloseEvent" , js_name = wasClean ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CloseEvent" , js_name = code ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "CloseEvent" , js_name = reason ) ]
