...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchObserver" , js_name = state ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchObserver" , js_name = onstatechange ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "FetchObserver" , js_name = onstatechange ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchObserver" , js_name = onrequestprogress ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "FetchObserver" , js_name = onrequestprogress ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "FetchObserver" , js_name = onresponseprogress ) ]
    ...
    # [ wasm_bindgen ( final , method , setter , js_class = "FetchObserver" , js_name = onresponseprogress ) ]
