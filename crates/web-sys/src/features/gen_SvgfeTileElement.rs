...
extern "C" {
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFETileElement" , js_name = in1 ) ]
    ...
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFETileElement" , js_name = x ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFETileElement" , js_name = y ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFETileElement" , js_name = width ) ]
    ...
    #[cfg(feature = "SvgAnimatedLength")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFETileElement" , js_name = height ) ]
    ...
    #[cfg(feature = "SvgAnimatedString")]
    # [ wasm_bindgen ( final , method , getter , js_class = "SVGFETileElement" , js_name = result ) ]
